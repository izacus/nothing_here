...
<div id="attachment_18" class="wp-caption aligncenter" style="width: 310px">
  <a href="http://www.virag.si/wp-content/uploads/2010/02/Sabayon-Linux-4-2-GNOME-Features-Tuz-Powered-Kernel-2.jpg"><img class="size-medium wp-image-18" title="Sabayon 4.2 Desktop" src="http://www.virag.si/wp-content/uploads/2010/02/Sabayon-Linux-4-2-GNOME-Features-Tuz-Powered-Kernel-2-300x240.jpg" alt="Sabayon 4.2 Desktop" width="300" height="240" /></a><p class="wp-caption-text">
    Sabayon 4.2 Desktop
  </p>
</div>
...
All in all Sabayon is a pleasant surprise when it comes to Linux distributions. The binary packages get rid of the greatest flaw of Gentoo’s portage while keeping its organisation. Having portage still installed and compatible means you still keep customizability of Gentoo without losing too much time and the “everything should work out of the box” mindset of creators means you’re not bothered by missing drivers or codecs when installing the distribution.
